...
import com.blog.blogapp.EditPostActivity;
...
public class PostsAdapter extends RecyclerView.Adapter<PostsAdapter.PostsHolder> {
    ...
    public void onBindViewHolder(@NonNull PostsHolder holder, int position) {
        ...
        holder.txtComments.setText(post.getComments()+" yorumu gör");
        holder.txtLikes.setText(post.getLikes()+" Beğeni");
    ...
    private void deletePost(int postId,int position){
        ...
        builder.setMessage("Gönderiyi silmek istediğinize emin misiniz?");
